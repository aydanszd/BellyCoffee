        ...
        <div className="bg-white min-h-screen mt-[150px]">
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-12">
                    <h1 className="text-5xl font-[Rubik] mb-4 ">Blog</h1>
                    <div className="flex items-center justify-center gap-2 text-gray-600 text-sm">
                        <span className='font-normal'>Home</span>
                        <span>/</span>
                        <span className='text-[#B3936D] font-normal'>Blog</span>
                    </div>
                </div>
                                    ...
                                    <div className="p-8 flex-1">
                                        ...
                                        <div className="flex items-center justify-between text-sm">
                                            <div className="flex items-center gap-2 text-black -mt-1">
                                                <MessageCircle className='mt-[-3px]' size={14} />
                                                <span className='text-[12px] font-bold'>{post.comments} COMMENTS</span>
                                            </div>
